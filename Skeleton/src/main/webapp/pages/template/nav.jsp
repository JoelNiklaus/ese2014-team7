			...
			<li id="header_inbox_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="dashgum/img/ui-zac.jpg"></span> <span
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="dashgum/img/ui-divya.jpg"></span> <span
...
<aside>
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<p class="centered">
				<a href="profile.html"><img src="dashgum/img/ui-sam.jpg"
			...
			<li class="mt"><a
				href="${pageContext.servletContext.contextPath}/map"> <i
					class="fa fa-map-marker"></i> <span>Map</span>
			</a></li>
			<li class="mt"><a
				href="${pageContext.servletContext.contextPath}/search"> <i
			...
			<li class="sub-menu"><a href="javascript:;"> <i
				...
				<ul class="sub">
					<li><a
						href="${pageContext.servletContext.contextPath}/createAd">Create
							Ads</a></li>
